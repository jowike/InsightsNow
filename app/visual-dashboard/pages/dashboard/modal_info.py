                ...
                [
                    ...
                    dbc.ModalBody(
                        [
                            ...
                            html.P(
                                [
                                    "This Nowcasting Tool ",
                                    html.Strong("transforms economic forecasting"),
                                    ".",
                                ]
                            ),
                            html.P(
                                [
                                    ...
                                    html.Strong(
                                        "comprehensive outlook on market conditions"
                                    ),
                                ...
                                [
                                    ...
                                    html.Li(
                                        [
                                            ...
                                            html.Strong(
                                                "cutting-edge econometrics and machine learning"
                                            ),
                                            ".",
                                        ]
                                    ),
                            ...
                            html.P(
                                [
                                    ...
                                    "The ",
                                    html.Strong(
                                        "chart visualizes period-over-period percentage changes"
                                    ),
                            ...
                            html.H6(
                                "⏰ Real-Time Monitoring Insights", className="fw-bold"
                            ),
                            html.P(
                                [
                            ...
                            html.P(
                                [
                                    "Additionally, the panel includes information on ",
                                    html.Strong("Kedro-Viz status"),
                                    ":",
                                ]
                            ),
                            html.Ul(
                                [
                                    ...
                                    html.Li(
                                        [
                                            "If ",
                                            html.Strong("not running"),
                                            " or ",
                                            html.Strong("stopped after execution"),
                                                ...
                                                [
                                                    html.Li(
                                                        [
                                                            "Edit ",
                                                            html.Strong(
                                                                "Kedro pipeline run configuration"
                                                            ),
                                                            " and/or ",
                                                            html.Strong(
                                                                "data catalog files"
                            ...
                            html.P(
                                [
                                    ...
                                    html.Strong("Kedro Run"),
                                    " standalone button triggers the nowcasting estimation process by executing the ",
                                    html.Strong("Kedro pipeline"),
                                    " (",
                                    html.Span("kedro run", style={"color": "green"}),
                                    ").",
                                ]
                            ),
                            html.P(
                                [
                                    ...
                                    html.Strong("Kedro Viz"),
                                    " button launches ",
                                    html.Strong("Kedro Viz"),
                                    ", which visualizes the pipeline structure, displaying ",
                                    html.Strong("data, nodes, and their connections"),
                                    " within the Kedro project.",
                                ]
                            )
